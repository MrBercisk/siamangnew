...
class DataPresensiModel extends Model
{
    ...
    protected $allowedFields = ['user_id', 'bidang_id', 'kategori_id', 'tbl_pendaftaran.nama_peserta','status_presensi', 'tbl_jadwal.tanggal_bimbingan', 'tanggal_presensi', 'keterangan_presensi', 'jam', 'updated_at'];
    ...
    function __construct()
    {
        ...
        $this->dt->select('tbl_presensi.*, tbl_pendaftaran.nama_peserta'); // Menambahkan kolom nama_peserta dari tabel tbl_pendaftaran
